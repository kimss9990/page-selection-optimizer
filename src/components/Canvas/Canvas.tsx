...
export function Canvas() {
  ...
  const placements = isManualMode ? manualPlacements : selectedResult.placements;
  ...
  return (
    ...
    >
      ...
      {/* 줌 컨트롤 */}
      <div className="absolute bottom-4 right-4 flex items-center gap-2 bg-white rounded-lg shadow px-3 py-2">
        <button
